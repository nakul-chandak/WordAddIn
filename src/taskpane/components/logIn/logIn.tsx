  ...
  return (
    <>
      <div className="ms-Grid">
        ...
        <div className={` "ms-Grid-row" ${styles.header1}`} style={{ padding: '0px' }}>
          <div className="ms-Grid-col ms-sm12 ms-xl12">
            <div className="ms-Grid-row">
              ...
              <div className="ms-Grid-col ms-sm12 ms-xl6">
                <div id="landing-right" className={styles.landingRight} style={{ lineHeight: '2rem' }}>
                  <h2 style={{ margin: '0px' }}>The most advanced integrated suite for AI productivity and protection</h2>
                </div>
